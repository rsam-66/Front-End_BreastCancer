...
const props = defineProps({
    ...
    doctor: {
        type: Object,
        default: () => ({ username: '', email: '', status: '', name: '' })
    }
})
...
watch(() => props.doctor, (newVal) => {
    if (newVal) {
        // Handle both 'username' and 'name' for compatibility
        form.value = {
            username: newVal.username || newVal.name || '',
            email: newVal.email || '',
    ...
    <BaseModal :isOpen="isOpen" title="Edit Doctor" @close="$emit('close')" :showCloseButton="false"
        ...
        <div class="space-y-6 px-2">
            ...
            <div class="flex items-center gap-4">
                ...
                <input v-model="form.password" type="password" placeholder="(Unchanged)"
