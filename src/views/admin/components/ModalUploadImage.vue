...
const handleFileChange = (event) => {
    ...
    if (file) {
        // Create a fake local URL for preview since we don't have a backend
...
<template>
    <BaseModal :isOpen="isOpen" title="Upload Patient Image" @close="$emit('close')">
        <div class="space-y-4">
            <div v-if="patient" class="bg-blue-50 p-3 rounded-lg mb-4 text-sm text-blue-800">
            ...
            <div
                ...
                <div v-else class="relative">
                    <img :src="previewUrl" class="max-h-48 mx-auto rounded-lg shadow-sm" />
                    <button @click.stop="previewUrl = null"
        ...
        <template #footer>
            ...
            <button @click="handleSubmit" :disabled="!previewUrl"
