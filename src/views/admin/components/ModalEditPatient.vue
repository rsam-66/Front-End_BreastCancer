...
<template>
    <BaseModal :isOpen="isOpen" title="Edit Patient Details" @close="$emit('close')" :showCloseButton="false"
        :centerTitle="true">
        <div class="space-y-6 px-2">
            ...
            <div class="flex items-start gap-4">
                <label class="w-32 pt-2 text-sm font-semibold text-gray-600">Cancer Scan</label>
                <div class="flex-1">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <input type="file" accept="image/*" @change="handleFileChange" class="block w-full text-xs text-gray-500
                                file:mr-2 file:py-2 file:px-3
                                file:rounded-lg file:border-0
                                file:text-xs file:font-semibold
                                file:bg-[#0099ff]/10 file:text-[#0099ff]
                                hover:file:bg-[#0099ff]/20
                                cursor-pointer" />
                            <p class="text-[10px] text-gray-500 mt-2">Upload a new scan to replace the current one.</p>
                        </div>
                    </div>
                </div>
            </div>
