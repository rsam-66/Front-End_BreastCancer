<script setup>
import { stats, activities } from '../data/dashboardData.js'
...
const getActivityIconColor = (index) => {
  ...
  const colors = ['bg-green-100 text-green-600', 'bg-blue-100 text-[#0099ff]', 'bg-[#dbeafe] text-[#006699]', 'bg-green-100 text-green-600']
...
<template>
  <div class="w-full">
    ...
    <!-- Stats Cards (Reused from DashboardDoctor) -->
      ...
      <div class="space-y-4">
        <div v-for="(activity, index) in activities" :key="activity.id"
          ...
          <div class="flex items-center gap-4">
            ...
            <!-- Text Info -->
            <div>
              <p class="font-bold text-gray-700 text-lg leading-tight">{{ activity.title }}</p>
